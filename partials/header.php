...
<header class="flex-center" style="background-color: #ddd; justify-content: space-between; padding: 20px 50px; position: sticky; top: 0;">
    ...
    <nav class="flex-center">
        <ul class="flex-center" style="list-style-type: none;">
            <li><a class="<?= $_SERVER['REQUEST_URI'] === '/' ? "selected" : "not-selected"?>" style="text-decoration: none;" href="<?=ROOT?>"><button>Home</button></a></li>
            <li><a class="<?= $_SERVER['REQUEST_URI'] === '/projecten' ? "selected" : "not-selected"?>" style="text-decoration: none;" href="<?=ROOT?>/projecten"><button>Projecten</button></a></li>
            <li><a class="<?= $_SERVER['REQUEST_URI'] === '/over-mij' ? "selected" : "not-selected"?>" style="text-decoration: none;" href="<?=ROOT?>/over-mij"><button>Over mij</button></a></li>
        </ul>
        <div class="flex-center">

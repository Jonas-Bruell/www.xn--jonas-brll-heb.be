<main>
    ...
    <section>
        <div class="project-tile">
            <div>
                <h1>Jonas Brüll</h1>
                <p>Ik ben een 20 jaar oude student computerwetenschappen aan de VUB. Ik werk al heel mijn leven graag
                    met computers - heb er op mijn 15e zelf een in elkaar gestoken - en ben van nature uit nieuwsgierig
                    naar hoe de wereld in elkaar zit.</p>
            </div>
            <div style="width: 70px;"></div>
            <img src="img/jonas-brull.jpg" alt="profielfoto Jonas Brüll" title="Profielfoto Jonas Brüll" width=300px
                 height=300px>
    ...
    <section class="grid" style="padding-top: 5vw; display: grid; gap: 2rem;">
        <?php function makeRating($array)
        {
            foreach ($array as $rating) {
                $text = $rating[0];
                $stars = $rating[1];
                include ROOT . "/partials/rating.php";
            }
        } ?>
